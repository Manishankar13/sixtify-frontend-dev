...
import { useGetIncomeTaxRegimeQueryFn, type IncomeTaxRegimePayload } from "./hooks/usegetIncomeTaxRegime";
...
export const IncomeTaxRegimeList = forwardRef(
    (
        ...
        const [currentIncomeTax, setCurrentIncomeTax] = useState<IncomeTaxRegimePayload>();
