    ...
    const categoryItems: CategoryItem[] = [
        {
            ...
            onClick: () => router.push("/pay-roll/settings/taxes-deductions?tab=income-tax-regime"),
        },
        {
            value: "pt-group",
            title: "PT Group",
            onClick: () => router.push("/pay-roll/settings/taxes-deductions?tab=pt-group"),
        },
        {
            value: "investment-deduction",
            title: "Investment Deduction",
            onClick: () =>
                router.push("/pay-roll/settings/taxes-deductions?tab=investment-deduction"),
        },
    ];
